...
var xe = {
	...
	constructor(e) {
		if (super(e), this.it = L, e.type !== xe.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
	}
	render(e) {
...
var X = Se(Y), we = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-sun-icon lucide-sun\"><circle cx=\"12\" cy=\"12\" r=\"4\"/><path d=\"M12 2v2\"/><path d=\"M12 20v2\"/><path d=\"m4.93 4.93 1.41 1.41\"/><path d=\"m17.66 17.66 1.41 1.41\"/><path d=\"M2 12h2\"/><path d=\"M20 12h2\"/><path d=\"m6.34 17.66-1.41 1.41\"/><path d=\"m19.07 4.93-1.41 1.41\"/></svg>", Te = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-moon-icon lucide-moon\"><path d=\"M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401\"/></svg>";
//#endregion
...
var Q = class extends K {
    ...
    .header-inner {
      ...
      max-width: var(--ui-header-max-width, 1440px);
      margin: 0 auto;
      padding: var(--ui-header-padding, 1rem 2rem);
      width: 100%;
    ...
    .icon-container {
      ...
      background-color: var(--color-flux-burgundy, #8B2E5F);
      display: flex;
      align-items: center;
    ...
    ::slotted([slot="app-description"]) {
      font-size: 0.75rem;
      color: var(--theme-text-secondary, #4A4A4A);
      margin-top: 0.375rem;
      margin-bottom: 0;
    }
    ...
    .theme-toggle:hover {
      /* Utilizamos el color de acento de Flux para darle vida */
      color: var(--color-flux-accent, #D946A6);
      /* Un fondo sutil mezclando el color de acento con transparente */
      background-color: color-mix(in srgb, var(--color-flux-accent) 15%, transparent);
      transform: translateY(-2px) scale(1.05);
      box-shadow: 0 4px 12px color-mix(in srgb, var(--color-flux-accent) 10%, transparent);
    }
  ...
  `;
	...
	toggleTheme() {
		this.theme = this.theme === "light" ? "dark" : "light", this.dispatchEvent(new CustomEvent("theme-change", {
        ...
        <div class="header-inner">
          <div class="left-zone">
            ...
            <div class="title-container">
              ...
              <slot name="app-description"></slot>
            </div>
          </div>
...
Z([J({
	type: String,
	reflect: !0
})], Q.prototype, "theme", void 0), Q = Z([q("ui-header")], Q);
//#endregion
//#region src/assets/icons/github.svg?raw
var Ee = "<svg fill=\"currentColor\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z\"/></svg>\n", $ = class extends K {
	constructor(...e) {
		super(...e), this.githubUrl = "#";
	}
	static {
		this.styles = o`
    :host {
      display: block;
      width: 100%;
      margin-top: auto; /* Pushes the footer to the bottom of flex containers */
    }
    
    footer {
      width: 100%;
      background-color: var(--theme-surface, transparent);
      border-top: 1px solid var(--theme-border, transparent);
      transition: background-color 0.2s, border-color 0.2s;
      font-size: 0.75rem;
      color: var(--theme-text-secondary, #4A4A4A);
    }
    ...
    .footer-inner {
      ...
      align-items: center;
      justify-content: space-between;
      max-width: var(--ui-header-max-width, 1440px); /* Reusing the max-width token for consistency */
      margin: 0 auto;
      padding: 1rem 2rem;
      width: 100%;
      box-sizing: border-box;
	...
	render() {
      ...
      <footer>
        <div class="footer-inner">
          <div class="left-zone">
            <span class="signature-text">&gt; sys_admin: ~/$ &copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Open Source</span>
          </div>
          
          <div class="center-zone">
            <a href="${this.githubUrl}" class="github-link" aria-label="GitHub Repository" target="_blank" rel="noopener noreferrer">
              <span class="github-icon">${X(Ee)}</span>
              GitHub
            </a>
            <div class="license-separator"></div>
            <slot name="footer-license"></slot>
          </div>

          <div class="right-zone">
            <slot name="footer-version"></slot>
          </div>
        </div>
      </footer>
    `;
...
Z([J({ type: String })], $.prototype, "githubUrl", void 0), $ = Z([q("ui-footer")], $);
//#endregion
